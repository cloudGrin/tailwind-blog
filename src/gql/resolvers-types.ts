...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  views?: Resolver<ResolversTypes['Int'], ParentType, ContextType, RequireFields<MutationViewsArgs, 'postName'>>;
}>;

export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  addViewCount?: Resolver<ResolversTypes['BlogPostViews'], ParentType, ContextType, RequireFields<QueryAddViewCountArgs, 'postName'>>;
}>;

export type Resolvers<ContextType = any> = ResolversObject<{
  BlogPostViews?: BlogPostViewsResolvers<ContextType>;
